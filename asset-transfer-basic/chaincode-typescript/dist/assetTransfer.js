...
let AssetTransferContract = class AssetTransferContract extends fabric_contract_api_1.Contract {
    async InitLedger(ctx) {
        ...
        for (const asset of assets) {
            ...
            await ctx.stub.putState(asset.ID, Buffer.from(json_stringify_deterministic_1.default(sort_keys_recursive_1.default(asset))));
    ...
    async CreateAsset(ctx, id, color, size, owner, appraisedValue) {
        ...
        // we insert data in alphabetic order using 'json-stringify-deterministic' and 'sort-keys-recursive'
        await ctx.stub.putState(id, Buffer.from(json_stringify_deterministic_1.default(sort_keys_recursive_1.default(asset))));
    }
    ...
    async UpdateAsset(ctx, id, color, size, owner, appraisedValue) {
        ...
        // we insert data in alphabetic order using 'json-stringify-deterministic' and 'sort-keys-recursive'
        return ctx.stub.putState(id, Buffer.from(json_stringify_deterministic_1.default(sort_keys_recursive_1.default(updatedAsset))));
    }
